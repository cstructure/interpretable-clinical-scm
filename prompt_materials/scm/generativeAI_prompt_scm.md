...
# SDY1760 Prompt
Review the Midwest Healthcare Conference Causal Diagram Challenge for context and update this structural causal model <SCM> for evaluating steroids safety and efficacy on 28 day survival in hospitalized patients.  
Review the sdy1760_data_dictionary and add features consistent with the expected graphml format using featureSource="sdy1760.csv":
...
# SDY1760 Prompt
Write a new graphml file using the EXACT SAME NODES AND EDGES as <SCM> with sdy1760 features @sdy1760_data_dictionary.csv consistent with the expected graphml format (below) using featureSource="sdy1760.csv"

ONLY featureIDs within @sdy1760_data_dictionary.csv should be used, if a similar variable is not in the sdy1760 data dictionary then no values should be present for the sdy1760.csv featureSource
